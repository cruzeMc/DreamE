...
public class MainActivity extends CustomActivity {
	...
	private ArrayList<Data> getDummyLeftNavItems() {
		...
		al.add(new Data("Category", R.drawable.ic_nav1, R.drawable.ic_nav1_sel));
		...
		al.add(new Data("My Program", R.drawable.ic_nav3, R.drawable.ic_nav3_sel));
		...
		al.add(new Data("Rate this app", R.drawable.ic_nav6, R.drawable.ic_nav6_sel));
		return al;
	}
